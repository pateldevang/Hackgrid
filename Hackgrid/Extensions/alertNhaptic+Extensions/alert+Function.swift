...
extension UIViewController
{
    ...
    internal func networkAlert(titlepass : String) {
        // Vibrates on errors
    ...
    //MARK: - ALERT function for general messages can be passes
    internal func genAlert(titlepass: String,message: String) {
        // Vibrates on errors
        UIDevice.invalidVibrate()
